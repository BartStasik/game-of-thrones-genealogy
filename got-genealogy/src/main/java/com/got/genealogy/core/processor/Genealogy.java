...
public class Genealogy {
    ...
    public static String findRelationship(String name1, String name2, String familyName) {
        ...
        System.out.println();
        int[] coordinates = family.calculateRelationCoords(family.getPerson(name1), family.getPerson(name2));
        ...
        int grandTimes, cousinTimes;

        Gender gender = family.getPerson(name1).getGender();
        String inLaw = "";
